...
class ShipmentOrderAdapter (var list: ArrayList<ShipmentOrder>, val callback: Callback) : RecyclerView.Adapter<ShipmentOrderAdapter.ViewHolder>() {
    ...
    interface Callback {
        fun onItemClicked(item: ShipmentOrder)
        fun onItemDelete(item: ShipmentOrder, position: Int)
    }
}